import { subarraySum } from '@/problems/subarraySumEqualsK';
...
describe('Subarray Sum Equals K', () => {
    ...
    it('should handle edge cases', () => {
        ...
        expect(subarraySum([1, 0, 1, 0, 1], 1)).toBe(8);

        // Zero sum subarrays
        expect(subarraySum([0, 0, 0], 0)).toBe(6); // All possible subarrays
    });
    ...
    it('should handle larger arrays', () => {
        ...
        expect(subarraySum(nums, k)).toBe(4);
    });
});
